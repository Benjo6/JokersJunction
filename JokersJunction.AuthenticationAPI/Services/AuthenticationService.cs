using Grpc.Core;
using JokersJunction.AuthenticationAPI.Protos;
using JokersJunction.Shared.Models;
using Microsoft.AspNetCore.Identity;
using Microsoft.IdentityModel.Tokens;
using static JokersJunction.AuthenticationAPI.Protos.Authorizer;
using System.IdentityModel.Tokens.Jwt;
using System.Security.Claims;
using System.Text;
using LoginRequest = JokersJunction.AuthenticationAPI.Protos.LoginRequest;
using RegisterRequest = JokersJunction.AuthenticationAPI.Protos.RegisterRequest;

namespace JokersJunction.AuthenticationAPI.Services;

public class AuthenticationService : AuthorizerBase
{
